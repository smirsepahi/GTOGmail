...
import { X, Mail, User, ArrowRight, Calendar } from 'lucide-react'
...
export default function SignUpModal({ isOpen, onClose }: SignUpModalProps) {
  const { signUp, connectEmail, connectCalendar } = useAuth()
        ...
        {step === 'connect-email' && (
          <>
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600">
                Connect your email and calendar to unlock all features
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                <h3 className="text-sm font-medium text-gray-700 mb-3">Connect Email</h3>
              ...
              {/* Calendar Section */}
              <div>
                <h3 className="text-sm font-medium text-gray-700 mb-3">Connect Calendar</h3>
                <button
                  onClick={handleCalendarConnect}
                  disabled={isLoading}
                  className="w-full bg-green-600 text-white py-3 px-4 rounded-lg hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
                >
